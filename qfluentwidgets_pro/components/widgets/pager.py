...
from ...common.color import isDarkTheme, themeColor
from ...common.icon import FluentIcon
from .button import TransparentToolButton
from .label import BodyLabel
from .line_edit import LineEdit
from .tool_tip import ToolTipPosition, setToolTipInfos
...
class Pager(QWidget):
    ...
    def __init__(self, pages: int, maxVisible: int, parent=None):
        ...
        setToolTipInfos(
            ...
            [
                self.tr("Jump to first page"),
                self.tr("Jump to last page"),
    ...
    def __initWidget(self):
        ...
        self.jumpLabel: BodyLabel = BodyLabel(self.tr("Page"))
        self.countLabel: BodyLabel = BodyLabel(self.tr("Total ") + str(self.__pages))
    ...
    def __updateButtons(self) -> None:
        ...
        self._widgetLayout.addStretch(1)
    ...
    def setPages(self, number: int) -> None:
        if self.__pages == number:
            return
        self.__pages = number
        self.countLabel.setText(self.tr("Total ") + str(self.__pages))
        self.__updateButtons()
