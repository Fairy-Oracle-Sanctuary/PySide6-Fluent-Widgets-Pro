...
class BasicInputInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            TransparentPushButton(
                self.tr("Transparent push button"), self, FluentIcon.BOOK_SHELF
            ),
            "https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/basic_input/button/demo.py",
        )
        ...
        # split button
        button = SplitPushButton(
            self.tr("Choose your stand"), self, FluentIcon.BASKETBALL
        )
        ...
        self.addExampleCard(
            ...
            TransparentTogglePushButton(
                self.tr("Start practicing"), self, FluentIcon.BASKETBALL
            ),
            "https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/basic_input/button/demo.py",
        )
    ...
    def createStandMenu(self, button):
        ...
        menu.addActions(
            [
                Action(
                    self.tr("Star Platinum"),
                    triggered=lambda c=True, b=button: b.setText(
                        self.tr("Star Platinum")
                    ),
                ),
                Action(
